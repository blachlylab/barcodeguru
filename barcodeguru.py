...
# barcodeguru.py
#
# Copyright 2013 James S Blachly, MD and The Ohio State University
#
...
if __name__ == "__main__":
	...
	print("Duplication:\t" + ruleDuplication(barcodes))
	print("Pool size:\t" + rulePoolSize(barcodes))
	print("Dual Lasers:\t" + ruleLasers(barcodes))
	print("Base Matches:\t" + ruleBaseMatch(barcodes))
	print("")
